...
lazy_static! {
    static ref UNPREFIXED_INSTRUCTIONS:  Vec<Instruction> = vec![
        ...
        Instruction::new(InstructionType::LD, AddressingMode::RegisterAddressToRegister, RegisterType::A, RegisterType::BC, ConditionType::None, None),
        ...
        Instruction::new(InstructionType::ADD, AddressingMode::U8, RegisterType::A, RegisterType::None, ConditionType::None, None),
        ...
        Instruction::new(InstructionType::ADD, AddressingMode::I8ToRegister, RegisterType::SP, RegisterType::None, ConditionType::None, None),
